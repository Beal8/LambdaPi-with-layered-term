...
module Compdynlink = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Compdynlink instead"]
module Compdynlink_common = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Compdynlink_common instead"]
module Compdynlink_platform_intf = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Compdynlink_platform_intf instead"]
module Compdynlink_types = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Compdynlink_types instead"]
...
module Compplugin = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Compplugin instead"]
...
module Debuginfo = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Debuginfo instead"]
...
module Int_replace_polymorphic_compare = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Int_replace_polymorphic_compare instead"]
...
module Middle_end = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Middle_end instead"]
...
module Semantics_of_primitives = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Semantics_of_primitives instead"]
...
module TypedtreeIter = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.TypedtreeIter instead"]
